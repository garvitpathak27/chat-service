...
class AuthServiceStub:
    ...
    def __init__(self, channel):
        ...
        self.GetPermissions = channel.unary_unary(
                ...
                request_serializer=auth__pb2.TokenRequest.SerializeToString,
                response_deserializer=auth__pb2.PermissionsResponse.FromString,
                _registered_method=True)
...
def add_AuthServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetPermissions': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=auth__pb2.TokenRequest.FromString,
                    response_serializer=auth__pb2.PermissionsResponse.SerializeToString,
            ),
    }
...
class AuthService:
    ...
    def GetPermissions(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            '/auth.AuthService/GetPermissions',
            auth__pb2.TokenRequest.SerializeToString,
            auth__pb2.PermissionsResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
